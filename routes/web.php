...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'verified']], function () {
    ...
    // Event
    Route::post('events/csv', [EventController::class, 'csvStore'])->name('events.csv.store');
    Route::put('events/csv', [EventController::class, 'csvUpdate'])->name('events.csv.update');
    ...
    // City
    Route::post('cities/csv', [CityController::class, 'csvStore'])->name('cities.csv.store');
    Route::put('cities/csv', [CityController::class, 'csvUpdate'])->name('cities.csv.update');
    Route::resource('cities', CityController::class, ['except' => ['store', 'update', 'destroy']]);

    // Medical Record
    Route::post('medical-records/csv', [MedicalRecordController::class, 'csvStore'])->name('medical-records.csv.store');
    Route::put('medical-records/csv', [MedicalRecordController::class, 'csvUpdate'])->name('medical-records.csv.update');
    Route::resource('medical-records', MedicalRecordController::class, ['except' => ['store', 'update', 'destroy']]);
